...
<html>
  <head>
    ...
    />
    <script
      src="https://kit.fontawesome.com/f8167db045.js"
      crossorigin="anonymous"
    ></script>
  </head>
  <body>
      ...
      <section>
        ...
        <div class="sUserAndDate">
          <div class="sUser">
            <img
              class="sUser_userImg"
              src="https://upload.wikimedia.org/wikipedia/ko/thumb/d/d4/%ED%8E%AD%EC%88%98.jpg/450px-%ED%8E%AD%EC%88%98.jpg"
              alt="userImg"
            />
        ...
        <ul class="sboard">
          ...
          <li class="sboard-1">
            ...
            <span class="sboard-3"
              ><fmt:formatDate value="${board.SDate}" pattern="yyyy-MM-dd"
            /></span>
          </li>
          <li class="sboard-1">
